    ...
    <main>
        <div class="appeal">
            ...
            <div class="location">
                ...
                <a href="./news.html">News01 <span>></span></a>
                <span>News</span>
            </div>
        </div>
        <section class="section-title" id="news-container">
            <div class="heading">
                <p data-title="お知らせ">News</p>
            </div>
            <div class="news-row">
                <div class="aside">
                    <div class="op-title">
                    ...
                    <article class="news-article aside-news">
                        <a href="./news01.html">
                            <div class="head">
        ...
        <!-- <section class="section-title direct-panel">
            <div class="panel">
                <div class="company-panel">
                    <a href="./company.html">
                        <p data-title="会社概要">Company</p>
                    </a>
                </div>
                <div class="contact-panel">
                    <a href="./contact.html">
                        <p data-title="お問い合わせ">Contact Us</p>
                    </a>
                </div>
            </div>
        </section> -->
